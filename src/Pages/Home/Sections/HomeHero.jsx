...
const HomeHero = () => {
  return (
    <div className="relative w-full h-[600px] 2xl:h-[660px] overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 flex flex-col justify-center h-full mt-12 container">
        {/* Centered Heading */}
        ...
        <p className="text-white text-lg md:text-xl md:max-w-[330px] text-left mt-10 py-6">
